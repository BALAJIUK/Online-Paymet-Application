            ...
            <table className="table" id="myTable">
              <thead className="thead-dark">
                ...
                {state.bill.bills.map((item, index) => (
                  <tr key={index}>
                    {" "}
                    <th className="subtracted" scope="row">{item.billType}</th>
                    <th className="subtracted" scope="row">{item.paymentDate}</th>
                    <th className="subtracted" scope="row">₹{item.amount}</th>
                  </tr>
                ))}
              </tbody>
            </table>
