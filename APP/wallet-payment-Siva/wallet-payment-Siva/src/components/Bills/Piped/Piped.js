...
export const Piped = () => {
  ...
  const picselect = (e) => {
    ...
    bgpic.current.classList.remove("gail");
    bgpic.current.classList.remove("adani");
    setshow1(false);
    if (e.target.value !== "") {
      console.log(e.target.value);
      if (e.target.value === "gail") {
        bgpic.current.classList.add("gail");
        bgpic.current.classList.remove("bg");
        setshow1(true);
      }
      if (e.target.value === "adani") {
        bgpic.current.classList.add("adani");
        bgpic.current.classList.remove("bg");
        setshow1(true);
      }
    }
