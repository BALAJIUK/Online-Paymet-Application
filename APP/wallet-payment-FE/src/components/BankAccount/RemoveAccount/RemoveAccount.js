...
import { deleteAccount, getAccounts } from "../../../redux/reducers/bankReducer";
                ...
                <div className="d-flex justify-content-center">
                  <Card style={{ width: "30vh" }}>
                    ...
                    <ListGroup className="list-group-flush text-center">
                      <ListGroupItem className="b">Account No:{item.accountNo}</ListGroupItem>
                      <button className="delete" onClick={remove} value={item.accountNo}><AiFillDelete/></button>
                    </ListGroup>
                  </Card>
                </div>
            </div>
